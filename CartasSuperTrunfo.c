...
int main (){
    ...
    int pontos_turisticos1, pontos_turisticos2, populacao, area, pib, pontos_turisticos, pib_per_capital, super_poder, densidade;
    ...
    inverso_densidade1 = (float) area1 / populacao1;
    ...
    super_poder1 = (float) populacao1 + area1 + pib1 + pontos_turisticos1 + pib_per_capital1 + inverso_densidade1;
